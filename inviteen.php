...
<?php
	...
	echo "<span class = 'errors'>".$errors[3]."</span>";
				...
				<label class="form__choice"><input type="checkbox" name="food[2]" value="1">I'm a veggie</label><br>
				<label class="form__choice"><input type="checkbox" name="food[3]" value="1">I love everything!</label><br>

				<textarea class= "food_comment" placeholder="If your partner has allergy, any restrictions in meal or beverages, or just wishes to organization of wedding, please write it here" name ="food-comment"></textarea>
				</div>
<?php
	if(isset($errors["2"])) {
	echo "<span class = 'errors'>".$errors[2]."</span>";
			...
			<label class="form__choice"><input type="radio" class="form__choice_partner" name="partner" value="2">with my wife/girlfriend</label><br>
				...
				<div class= "partner_preferences" style="display: none;"> 
						...
						?>
						<hr>
						<h4>My partner will be drinking...</h4>
						...
						<label class="form__choice"><input type="checkbox" name="pdrink[3]" value="1">
champagne</label><br>
						...
						?>
						<h4>From food my partner prefers...</h4>
						...
						<label class="form__choice"><input type="checkbox" name="pfood[2]" value="1">I'm a veggie</label><br>
						<label class="form__choice"><input type="checkbox" name="pfood[3]" value="1">I love everything!</label><br>
			...
			<h4><label><input type="checkbox" class="form__children" name="children" value="Да">I also bring my children to the wedding day:</label></h4><br>
