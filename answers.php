...
<?php
		...
		$result = $mysqli->query($query);
   			...
   			while ($row = $result->fetch_assoc()) {
                ...
                if($row['lang'] == 'de') {
					echo '<td 	style="word-break: break-all;"><a target="_blank" href="http://wedding2.com:8080/invitede.php?'.http_build_query($data).'">http://wedding.com:8080/invitede.php?'.http_build_query($data).'</a></td>';	
				}else if($row['lang'] == 'en') {
					echo '<td 	style="word-break: break-all;"><a target="_blank" href="http://wedding2.com:8080/inviteen.php?'.http_build_query($data).'">http://wedding.com:8080/inviteen.php?'.http_build_query($data).'</a></td>';	
				} else if($row['lang'] == 'ru'){
	                echo '<td 	style="word-break: break-all;"><a target="_blank" href="http://wedding2.com:8080/invite.php?'.http_build_query($data).'">http://wedding.com:8080/invite.php?'.http_build_query($data).'</a></td>';
               	} else {
               		echo '<td>'.'</td>';
               	}
                echo "</tr>";
