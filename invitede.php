		...
		if($_SERVER['REQUEST_METHOD'] == 'POST') {
		  ...
		  /*  if (empty($_POST["firstname"]) || empty($_POST["lastname"])) {
		  	...
		  	if (empty($_POST["pfood"])) {
		    		$errors[5] = "Du hast die Frage nicht beantwortet...";
		  	}  

		  	if (empty($_POST["pdrink"])) {
		    		$errors[6] = "Du hast die Frage nicht beantwortet...";
		  	}   
		...
		echo "<span class = 'errors'>".$errors[2]."</span>";
				...
				<label class="form__choice"><input type="radio" class="form__choice_partner" name="partner" value="2">mit meiner Ehefrau/Freundin</label><br>
					...
					<div class= "partner_preferences" style="display: none;"> 
							...
							?>
							<h4>Beim Essen bevorzugt mein Partner/meine Partnerin...</h4>
							...
							<textarea class= "food_comment" placeholder="Wenn dein/e Partner/in Allergien, spezielle Essens- oder Getränkewünsche hat, dann teile uns dies hier bitte mit." name ="pcommentFood"></textarea>
							<hr>
					</div>
