			...
			$count = $result->num_rows; 
		  	...
		  	if($_POST["choice"] == "Не смогу прийти") {	
				...
				/*Если партнер есть, то обновляем, если нет - добавляем */
		  		...
		  		echo "<span class = 'check'>"."Es scheint, dass du irgendwelche Frage verpasst"."</span>";
	  		}
	  	}	
	} 	
?>
...
<?php
	...
	<div style = "width: 100%;">
		...
		<label  class="form__choice"><input type="radio" class="form__decision" name="choice" value="Скорее всего буду">Ich werde sehr wahrscheinlich dabei</label><br>
	...
	echo "<span class = 'errors'>".$errors[2]."</span>";
			...
			<label class="form__choice"><input type="radio" class="form__choice_partner" name="partner" value="2">mit meiner Ehefrau/Freundin</label><br>
				...
				<div class= "partner_preferences" style="display: none;"> 
						...
						<label class="form__choice"><input type="checkbox" name="pfood[2]" value="1">Ich bin Vegetarianer </label><br>
						<label class="form__choice"><input type="checkbox" name="pfood[3]" value="1">Mir gefällt alles!</label><br>
